	...
	<body>
		...
		<div id="show-livre" class="content scaffold-show" role="main">
			...
			<ol class="property-list livre">
				...
				<g:if test="${livreInstance?.nombreExemplaireDisponibles}">
				<li class="fieldcontain">
					<span id="nombreExemplaireDisponibles-label" class="property-label"><g:message code="livre.nombreExemplaireDisponibles.label" default="Nombre Exemplaire Disponibles" /></span>
					
						<span class="property-value" aria-labelledby="nombreExemplaireDisponibles-label"><g:fieldValue bean="${livreInstance}" field="nombreExemplaireDisponibles"/></span>
