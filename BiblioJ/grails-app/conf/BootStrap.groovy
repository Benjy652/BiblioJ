...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		livre4.save()		
		def livre5 = new Livre(titre:"Limonov",nombreExemplaire:3,nombreExemplaireDisponibles:1,typeDocument:typeNouveaute)
		...
		livre7.save()		
		def livre8 = new Livre(titre:"La révolte",nombreExemplaire:3,nombreExemplaireDisponibles:0,typeDocument:typeLivreAdo)
